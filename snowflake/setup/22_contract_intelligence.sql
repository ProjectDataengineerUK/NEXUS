...
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS contract_type      VARCHAR(100);
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS contract_value_usd NUMBER(18,2);
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS start_date         DATE;
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS end_date           DATE;
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS auto_renewal       BOOLEAN     DEFAULT FALSE;
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS governing_law      VARCHAR(200);
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS clauses_extracted  VARIANT;
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS risk_flags         VARIANT;
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS ai_summary         VARCHAR(4000);
ALTER TABLE NEXUS_APP.CORE.DOCUMENTS ADD COLUMN IF NOT EXISTS extraction_status  VARCHAR(50)  DEFAULT 'pending';
