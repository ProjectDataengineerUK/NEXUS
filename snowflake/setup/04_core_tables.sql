...
-- Migrations: garante que colunas adicionadas após criação inicial existam
ALTER TABLE NEXUS_APP.CORE.CUSTOMERS ADD COLUMN IF NOT EXISTS arr                 DECIMAL(18,2);
ALTER TABLE NEXUS_APP.CORE.CUSTOMERS ADD COLUMN IF NOT EXISTS mrr                 DECIMAL(18,2);
ALTER TABLE NEXUS_APP.CORE.CUSTOMERS ADD COLUMN IF NOT EXISTS contract_start_date DATE;
ALTER TABLE NEXUS_APP.CORE.CUSTOMERS ADD COLUMN IF NOT EXISTS contract_end_date   DATE;
ALTER TABLE NEXUS_APP.CORE.CUSTOMERS ADD COLUMN IF NOT EXISTS nps_score           INTEGER;
