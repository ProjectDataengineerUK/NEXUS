...
ALTER TABLE CORE.PRODUCTS ADD COLUMN IF NOT EXISTS updated_at       TIMESTAMP_TZ;
...
ALTER TABLE CORE.INTERACTIONS ADD COLUMN IF NOT EXISTS occurred_at      TIMESTAMP_TZ;
...
-- GRANTs
GRANT SELECT ON TABLE CORE.ACCOUNTS     TO ROLE NEXUS_VIEWER;
GRANT SELECT ON TABLE CORE.PRODUCTS     TO ROLE NEXUS_VIEWER;
GRANT SELECT ON TABLE CORE.INTERACTIONS TO ROLE NEXUS_VIEWER;
GRANT INSERT, UPDATE ON TABLE CORE.ACCOUNTS     TO ROLE NEXUS_ADMIN;
GRANT INSERT, UPDATE ON TABLE CORE.PRODUCTS     TO ROLE NEXUS_ADMIN;
GRANT INSERT, UPDATE ON TABLE CORE.INTERACTIONS TO ROLE NEXUS_ADMIN;
